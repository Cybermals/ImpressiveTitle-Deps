...
mFadeInvisibleDist      (0.f)
{
   ...
   if (mRenderMethod == BB_METHOD_ACCELERATED)
   {
      ...
      if (s_nSelfInstances == 0)
      {
		 ...
		 HighLevelGpuProgramPtr vertexShader = static_cast<HighLevelGpuProgramPtr>(HighLevelGpuProgramManager::getSingleton().getByName("Sprite_vp"));
		 ...
		 HighLevelGpuProgramPtr vertexShader2 = static_cast<HighLevelGpuProgramPtr>(HighLevelGpuProgramManager::getSingleton().getByName("SpriteFade_vp"));
...
void StaticBillboardSet::setMaterial(const String &materialName, const Ogre::String &resourceGroup)
{
   ...
   if (mRenderMethod == BB_METHOD_ACCELERATED)
   {
	  ...
	  mPtrMaterial = static_cast<MaterialPtr>(MaterialManager::getSingleton().getByName(materialName, resourceGroup));
